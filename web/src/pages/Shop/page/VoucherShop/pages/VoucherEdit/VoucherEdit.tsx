...
export default function VoucherAdd() {
  ...
  useEffect(() => {
    if (updateData) {
      ...
      setValue('code', updateData.code.slice(5))
  ...
  const onSubmit = handleSubmit(async (data) => {
    ...
    try {
      const res = await updateMutaion.mutateAsync({
                  ...
                  <div className='col-span-9'>
                    ...
                    <div className='text-sm text-gray-400'>
                      ...
                      <p>
                        ...
                        <span className='uppercase'>{profile?.userName.slice(0, 5)}</span>
                  ...
                  <div className='col-span-9'>
                    <div
                      className={classNames(
                        ...
                        {
                          'border-gray-200': !errors.minimumTotalOrder?.message,
                  ...
                  <div className='col-span-9'>
                    <div
                      className={classNames(
                        ...
                        {
                          'border-gray-200': !errors.maxDistribution?.message,
                          'border-red-300': errors.maxDistribution?.message
                        }
                      )}
                    >
                      <input
