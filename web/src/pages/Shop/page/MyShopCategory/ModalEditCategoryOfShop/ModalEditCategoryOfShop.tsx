...
interface Props {
  category: CategoryOfShopResponse
}

export default function ModalEditCategoryOfShop({ category }: Props) {
  ...
  const categoryUpdateMutation = useMutation({
    mutationFn: categoryOfShopApi.updateCategory
  })
  ...
  return (
    <div className='h-auto w-auto'>
      ...
      <button className='hover:text-blue text-sm' onClick={open}>
        Edit
      </button>
    </div>
  )
